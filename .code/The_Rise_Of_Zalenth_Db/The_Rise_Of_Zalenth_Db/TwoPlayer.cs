...
namespace ZALENTH
{
    ...
    class TwoPlayer_P1
    {
        ...
        public static string version = "alzh0.0.1.3.5db";
        ...
        {
            Lists.Downloaded_DLC.Clear();
            if (Lists.first_player1)
            {
                ...
                Console.WriteLine("The Rise of Zalenth: Multiplayer");
                    ...
                    case "load":
                        ...
                        try
                        {
                            ...
                            if (savedfd == "saved")
                            {
                                ...
                                tr = new StreamReader(curetna + @"\MUSIC\SETTINGS\MUSICSETTINGS.txt");
        ...
        public static void TesatQ()
        {
            ...
            while (tell)
            {
                if (Lists.p1_moves > 0)
                {
                    ...
                    else
                    {
                        if (in_dungon == false)
                        {
                            ...
                            {
                                Console.Title = (health.ToString());
                                Console.WriteLine("LAND: {0} HP: {1}, CRLD: ({2} , {3}) LEVEL: {4} SCORE: {5} Player 1 Moves left: {6}", wourld, health, xc, yc, level, scorea, Lists.p1_moves);
                                Console.WriteLine("");
                                a = Console.ReadLine();
                                a = a.ToLower();
                                sw.Start();
                ...
                {
                    Lists.p2_moves_reset();
                    if (!Lists.first_player2)
                    {
                        Console.Clear();
                        Console.WriteLine("Please give the keyboard to player 1.");
                        Console.WriteLine("Press any key.");
                        Console.ReadKey();
                        TwoPlayer_P2.TesatQ();
                    }
